...
将模式设置成 none，以最原始状态打包，执行打包（折叠代码：ctrl +k、Ctrl+0），得到：
  ...
  ![webpack打包结构-立即执行函数](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/webpack打包结构-立即执行函数.png)

- 整体是一个立即执行函数，它是 webpack 工作入口，调用时传入了一个数组，展开这个数组，数组中每个元素都是参数列表相同的函数，整理的函数就是源代码中对应的模块，也就是说我们的模块都会被包裹到这样的函数中，从而实现模块私有作用域；

  ![webpack打包结构-模块](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/webpack打包结构-模块.png)
...
- 展开工作入口函数，函数内部并不复杂，最开始定义了一个 installedModules 对象，用于缓存加载过的模块，紧接着定义了一个\__webpack_require\__函数，这个函数用于加载模块，再往后就是在\__webpack_require\__ 挂载了一些数据和工具函数，执行到最后调用了\__webpack_require\__函数，传入了 0（moduleId）加载模块，这里的模块 ID 就是传入模块数组的下标。
  ...
  ![webpack打包结构-函数内部](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/webpack打包结构-函数内部.png)
...
- 1.最开始接收到的就是两个模块对应的函数；
  ...
  ![webpack-调试1](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/webpack-调试1.png)
...
- 2.中间不用管往下走，最后执行 \__webpack_require\__函数，\__webpack_require\__ 内部先判断模块有没有被加载过：
  ...
  ![webpack-调试2](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/webpack-调试2.png)

- 3.在模块内部首先调用了 \__webpack_require\__.r ，这个函数用于在导出对象上添加一个 \__esModule 标记，用于对外界标识这是一个 ES Module；

  ![webpack-调试3](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/webpack-调试3.png)

- 4.接着往后调用了 \__webpack_require\__(1)，加载第二个模块（也就是第一个模块的依赖），获取 "default"，接着再按照 2/3 两步加载依赖。第一个模块加载依赖后，执行主要流程；

  ![webpack-调试4](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/webpack-调试4.png)
...
![file-loader](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/file-loader.png)

再查看 \__webpack_require\__.p 发现它就是设置的 publicPath，这也就说明了 / 不能省略的原因。

![file-loader](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/file-loader2.png)
...
![url-loader1](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/url-loader1.png)

复制这个地址，在浏览器地址栏输入，图片可以正常显示。

![url-loader2](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/url-loader2.png)
...
![htmlcss](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/htmlcss.png)
...
![loader原理1](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/loader原理1.png)
...
![loader原理2](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/loader原理2.png)
...
![sourcemap](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/sourcemap.png)
...
![sourcemap2](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/sourcemap2.webp)
...
![eval1](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/eval1.png)
...
![eval2](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/eval2.png)
...
![优化1](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/优化1.png)

![优化2](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/优化2.png)
...
![优化3](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/优化3.png)
...
![treesharking](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/treesharking.png)

这是因为在最新版本的 babel-loader 中，自动关闭了 ES module 转换的插件，在 babel-loader (injectCaller.js)中是支持 es module 的

![treesharking1](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/treesharking1.png)

在 preset-env 中利用这个选项禁用了转换：

![treesharking2](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/treesharking2.png)
...
![treesharking3](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/treesharking3.png)
...
![treesharking4](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/treesharking4.png)
...
![副作用1](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/副作用1.png)
...
![副作用2](https://gitee.com/leixiaoai/markdown/raw/master/01.大前端/02.js基础/images/webpack/副作用2.png)
